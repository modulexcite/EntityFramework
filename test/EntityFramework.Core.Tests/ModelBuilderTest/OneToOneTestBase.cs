...
namespace Microsoft.Data.Entity.Tests
{
    public abstract partial class ModelBuilderTest
    {
        ...
        {
            [Fact]
            public void Finds_existing_navigations_and_uses_associated_FK()
            {
                var model = new Model();
            ...
            [Fact]
            public void Replaces_existing_navigation_to_principal()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
            ...
            [Fact]
            public void Finds_existing_navigation_to_dependent_and_uses_associated_FK()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
            ...
            [Fact]
            public void Creates_both_navigations_and_shadow_FK_if_existing_FK()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>()
            ...
            [Fact]
            public void Creates_both_navigations_and_new_FK()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<CustomerDetails>();
            ...
            [Fact]
            public void Creates_both_navigations_and_removes_existing_FK_when_not_specified()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
            ...
            [Fact]
            public void Creates_both_navigations_and_creates_new_FK_when_not_specified()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<OrderDetails>();
            ...
            [Fact]
            public void Creates_relationship_with_navigation_to_dependent_and_new_FK_from_principal()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_relationship_with_navigation_to_dependent_and_new_FK_from_dependent()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_relationship_with_no_navigations()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_both_navigations_and_uses_specified_FK_even_if_found_by_convention()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Creates_both_navigations_and_uses_specified_FK_even_if_PK()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_both_navigations_and_uses_existing_FK_not_found_by_convention()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
            ...
            [Fact]
            public void Creates_both_navigations_and_specified_FK()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<BigMak>();
            ...
            [Fact]
            public void Creates_relationship_with_specified_FK_with_navigation_to_dependent()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<BigMak>();
            ...
            [Fact]
            public void Creates_relationship_with_specified_FK_with_navigation_to_principal()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<BigMak>();
            ...
            [Fact]
            public void Creates_relationship_with_specified_FK_with_no_navigations()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<BigMak>();
            ...
            [Fact]
            public void Creates_both_navigationss_and_overrides_existing_FK_when_uniqueness_does_not_match()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<BigMak>();
            ...
            [Fact]
            public void Removes_existing_FK_when_specified()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Creates_FK_when_specified_on_dependent()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Creates_FK_when_specified_on_principal()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Creates_FK_when_specified_on_principal_with_navigation_to_dependent()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_FK_when_specified_on_dependent_with_navigation_to_principal()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_FK_when_specified_on_principal_with_navigation_to_principal()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_FK_when_specified_on_dependent_with_navigation_to_dependent()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_FK_when_specified_on_dependent_with_no_navigations()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_FK_when_specified_on_principal_with_no_navigations()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Can_use_alternate_principal_key()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Can_have_both_keys_specified_explicitly()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Can_have_both_keys_specified_explicitly_in_any_order()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Can_have_both_alternate_keys_specified_explicitly()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<BigMak>();
            ...
            [Fact]
            public void Can_have_both_alternate_keys_specified_explicitly_in_any_order()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<BigMak>();
            ...
            [Fact]
            public void Does_not_use_existing_FK_when_principal_key_specified()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Creates_principal_key_when_specified_on_dependent()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Creates_principal_key_when_specified_on_principal()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Creates_FK_when_principal_and_foreign_key_specified_on_dependent()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Creates_FK_when_principal_and_foreign_key_specified_on_dependent_in_reverse_order()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Creates_FK_when_principal_and_foreign_key_specified_on_principal()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Principal_and_dependent_cannot_be_flipped_twice()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Principal_and_dependent_cannot_be_flipped_twice_in_reverse_order()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Order>();
            ...
            [Fact]
            public void Creates_principal_key_when_specified_on_principal_with_navigation_to_dependent()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_principal_key_when_specified_on_dependent_with_navigation_to_principal()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_principal_key_when_specified_on_principal_with_navigation_to_principal()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_principal_key_when_specified_on_dependent_with_navigation_to_dependent()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_principal_key_when_specified_on_principal_with_no_navigations()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_principal_key_when_specified_on_dependent_with_no_navigations()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Creates_both_navigations_and_uses_existing_composite_FK()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
            ...
            [Fact]
            public void Creates_both_navigations_and_creates_composite_FK_specified()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Whoopper>().Key(c => new { c.Id1, c.Id2 });
            ...
            [Fact]
            public void Can_use_alternate_composite_key()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
            ...
            [Fact]
            public void Can_use_alternate_composite_key_in_any_order()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Whoopper>(b => b.Key(c => new { c.Id1, c.Id2 }));
            ...
            [Fact]
            public void Uses_composite_PK_for_FK_by_convention()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Whoopper>().Key(c => new { c.Id1, c.Id2 });
            ...
            [Fact]
            public void Principal_and_dependent_can_be_flipped_and_composite_PK_is_still_used_by_convention()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Whoopper>().Key(c => new { c.Id1, c.Id2 });
            ...
            [Fact]
            public void Principal_and_dependent_can_be_flipped_using_principal_and_composite_PK_is_still_used_by_convention()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Whoopper>().Key(c => new { c.Id1, c.Id2 });
            ...
            [Fact]
            public void Creates_composite_FK_when_specified_on_principal_with_navigation_to_dependent()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Whoopper>().Key(c => new { c.Id1, c.Id2 });
            ...
            [Fact]
            public void Creates_composite_FK_when_specified_on_principal_with_navigation_to_principal()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Whoopper>().Key(c => new { c.Id1, c.Id2 });
            ...
            [Fact]
            public void Creates_composite_FK_when_specified_on_principal_with_no_navigations()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Whoopper>().Key(c => new { c.Id1, c.Id2 });
            ...
            [Fact]
            public void Principal_and_dependent_can_be_flipped_when_self_referencing()
            {
            ...
            [Fact]
            public void Creates_self_referencing_FK_with_navigation_to_principal()
            {
                var modelBuilder = CreateModelBuilder();
            ...
            [Fact]
            public void Creates_self_referencing_FK_with_navigation_to_dependent()
            {
                var modelBuilder = CreateModelBuilder();
                modelBuilder.Entity<SelfRef>(eb =>
                    {
            ...
            [Fact]
            public void Throws_on_duplicate_navigation_when_self_referencing()
            {
                var modelBuilder = CreateModelBuilder();
            ...
            [Fact]
            public void Throws_if_specified_FK_types_do_not_match()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Throws_if_specified_PK_types_do_not_match()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Throws_if_specified_FK_count_does_not_match()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Throws_if_specified_PK_count_does_not_match()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<Customer>();
            ...
            [Fact]
            public void Can_add_annotations()
            {
                var model = new Model();
                var modelBuilder = CreateModelBuilder(model);
                modelBuilder.Entity<CustomerDetails>();
            ...
            [Fact]
            public void Nullable_FK_are_optional_by_default()
            {
            ...
            [Fact]
            public void Non_nullable_FK_are_required_by_default()
            {
                var modelBuilder = HobNobBuilder();
            ...
            [Fact]
            public void Nullable_FK_can_be_made_required()
            {
                var modelBuilder = HobNobBuilder();
            ...
            [Fact]
            public void Non_nullable_FK_cannot_be_made_optional()
            {
                var modelBuilder = HobNobBuilder();
            ...
            [Fact]
            public void Can_use_non_nullable_FK_if_optional()
            {
                var modelBuilder = HobNobBuilder();
            ...
            [Fact]
            public void Unspecified_FK_can_be_made_optional()
            {
                var modelBuilder = HobNobBuilder();
            ...
            [Fact]
            public void Can_be_defined_before_the_PK_from_principal()
            {
            ...
            [Fact]
            public void Can_be_defined_before_the_PK_from_dependent()
            {
                var modelBuilder = CreateModelBuilder(new Model());
